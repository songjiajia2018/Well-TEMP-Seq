...
genome_fa='/home/songjia/reference/human/Homo_sapiens.GRCh38.dna.primary_assembly.fa' # genome fasta file (mm10 or hg38)
...
perl /home/songjia/bigdisk/lsc/script/scripts/extrac_refT_readC.pl -tsv ${i}_both_strand_all_TC.tsv -qual 27

############ 6. QC output: summarise the all types of mutation rate
perl /home/songjia/bigdisk/lsc/script/scripts/extrac_conversion_frequency_gene_annotate.pl -read ${i}_ann_read.txt -tsv ${i}_both_strand_all.tsv -qual 27
